  ...
  return (
    <div className="app" data-theme="bitcoindesign" data-mode={isDarkMode ? "dark" : "light"}>
      ...
      <main className="main">
        ...
        {/* TypeScript demo - uncomment to see type errors */}
        {/* 
        <div>
          <bui-button
            style-type="invalid" // ❌ TypeScript error: Type '"invalid"' is not assignable to type 'ButtonStyleType'
            size="huge"           // ❌ TypeScript error: Type '"huge"' is not assignable to type 'ButtonSize'
