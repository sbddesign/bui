...
export class BuiMessage extends LitElement {
  ...
  constructor() {
    super();
    this.text =
      'For this small payment, you could save on fees by sending to a Lightning wallet.';
    this.mood = 'neutral';
    this.showIcon = true;
    this.icon = '';
  }
  ...
  private renderIcon() {
    ...
    const iconMap: Record<MessageMood, unknown> = {
      neutral: html`<svg viewBox="0 0 16 16">
        <circle
          cx="8"
          cy="8"
          r="7"
      ...
      success: html`<svg viewBox="0 0 16 16">
        <path
      ...
      caution: html`<svg viewBox="0 0 16 16">
        <path
          d="M8 1L15 14H1L8 1Z"
          stroke="currentColor"
          stroke-width="1.5"
      ...
      danger: html`<svg viewBox="0 0 16 16">
        <path
          d="M8 1L15 14H1L8 1Z"
          stroke="currentColor"
          stroke-width="1.5"
    ...
    return html`<div class="icon ${this.mood}">
      ${iconMap[this.mood] || iconMap.neutral}
    </div>`;
  }
