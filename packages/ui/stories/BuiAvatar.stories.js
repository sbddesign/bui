...
const createAvatarGrid = (avatarConfigs, containerSize = '64px') => {
  ...
  avatarConfigs.forEach((config) => {
    ...
    if (config.imageUrl2x)
      avatar.setAttribute('image-url-2x', config.imageUrl2x);
...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'A circular avatar component that can display either an image or a text-based gradient with optional initial letter.',
      },
    },
  },
  argTypes: {
    ...
    text: {
      control: 'text',
      description:
        'Text string used to generate gradient colors and optional initial letter',
    },
    showInitial: {
      control: 'boolean',
      description:
        'Whether to show the first character of the text (only when no image is provided)',
    },
    size: {
      control: 'select',
    ...
    createAvatarGrid([
      {
        ...
        imageUrl2x: './assets/avatars/Dog@2x.png',
        size: 'small',
        containerSize: '48px',
      },
      {
        imageUrl: './assets/avatars/Robot.png',
        imageUrl2x: './assets/avatars/Robot@2x.png',
        size: 'medium',
        containerSize: '64px',
      },
      {
        imageUrl: './assets/avatars/Dinosaur.png',
        imageUrl2x: './assets/avatars/Dinosaur@2x.png',
        size: 'large',
        containerSize: '80px',
      },
    ]),
  ...
  render: () =>
    createAvatarGrid([
      { text: 'Alice', showInitial: true, size: 'medium' },
      {
        ...
        imageUrl2x: './assets/avatars/Bird@2x.png',
        size: 'medium',
      },
...
export const AllAvatarImages = {
  render: () =>
    createAvatarGrid([
      ...
      {
        imageUrl: './assets/avatars/Alligator.png',
        imageUrl2x: './assets/avatars/Alligator@2x.png',
        size: 'medium',
        containerSize: '64px',
      },
    ]),
