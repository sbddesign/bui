...
<Meta title="Welcome to BUI" />

<div className="sb-container">
  <div className='sb-section-title'>
    # bui

    BUI is a design system and UI kit for building great user interfaces for bitcoin related projects. It builds upon other open source projects like [Bitcoin UI Kit](https://www.bitcoinuikit.com/), [Conduit](https://design.voltage.cloud/), and [Tailwind](https://tailwindcss.com/).
  </div>
