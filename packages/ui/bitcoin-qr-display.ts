...
export class BuiBitcoinQrDisplay extends LitElement {
  ...
  private renderQr() {
    ...
    const title =
      this.copyOnTap && !this.placeholder && !this.error ? 'Click to copy QR code data' : '';
      ...
      <div class="container">
        ${this.placeholder
          ...
          : this.error
            ...
            : this.complete
              ? html`<div class="helper-text" style="opacity: 0;">${this.helperText}</div>`
        ...
        ${this.placeholder
          ...
          : this.error
            ? this.shouldShowSelector
              ? html`<div class="options" style="opacity: 0;">${this.renderSelector()}</div>`
              : null
            : this.complete
              ? this.shouldShowSelector
                ? html`<div class="options" style="opacity: 0;">${this.renderSelector()}</div>`
